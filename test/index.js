...
module.exports = function (t, a) {
	...
	dom = dom.firstChild;
	a(dom.nodeName.toLowerCase(), 'div', "Match firstChild");
	...
	a(dom.nodeName.toLowerCase(), 'p', "Sibling element name");
	...
	a(dom.firstChild.nodeName.toLowerCase(), 'span', "Element child name");
