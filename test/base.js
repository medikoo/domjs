...
module.exports = function (t, a) {
	...
	dom = dom.firstChild;
	a(dom.nodeName.toLowerCase(), 'foo', "Match firstChild");
	...
	a(dom.nodeName.toLowerCase(), 'bar', "Sibling element name");
	...
	a(dom.firstChild.nodeName.toLowerCase(), 'foo', "Element child name");
